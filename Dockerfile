FROM test.zddata.cloud:8443/library/golang:1.23.2-alpine3.20 AS builder
...
COPY . .
# RUN go generate ./...
RUN echo "v1.9.2" > internal/core/VERSION
...
FROM test.zddata.cloud:8443/library/alpine:3.20.2
